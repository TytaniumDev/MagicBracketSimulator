...
void main() {
  ...
  group('scrubPii', () {
    test('redacts email-shaped values in event extras', () {
      ...
      expect(scrubbed.contexts['extra']!['okField'], 'no pii here');
    });
    ...
    test('redacts known PII keys', () {
      ...
      expect(scrubbed!.contexts['extra']!['email'], '[redacted]');
      expect(scrubbed.contexts['extra']!['uid'], '[redacted]');
      expect(scrubbed.contexts['extra']!['displayName'], '[redacted]');
      expect(scrubbed.contexts['extra']!['user_id'], '[redacted]');
      expect(scrubbed.contexts['extra']!['safe'], 'keep me');
    });
