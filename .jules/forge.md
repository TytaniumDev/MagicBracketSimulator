...
- **[2026-02-09]**: Calibrated `AGENTS.md` to align Analysis Service testing with CI. Replaced manual `uv` commands with `scripts/ci-analysis.sh` to enforce parity between local and CI execution contexts. Verified script runs correctly from `analysis-service` directory.
